...
urlpatterns = [
    ...
    path('artist_registration/', views.artist_registration_list, name='artist_registration_list'),
    path('artist_registration/download-csv/', views.download_csv, name='download_csv'),
    ...
    path('artist_statistics/', views.artist_statistics, name='artist_statistics'),
]
